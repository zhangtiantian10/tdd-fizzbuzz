...
public class GameSpec {
    ...
    @Test
    void should_return_FizzBuzz_when_divided_exactly_by_3_and_5() {
        Game game = new Game();
        assertThat(game.run(15)).isEqualTo( "FizzBuzz");
    }
    ...
    @Test
    void should_return_FizzBuzzWhizz_when_divided_exactly_by_3_and_5_and_7() {
        Game game = new Game();
